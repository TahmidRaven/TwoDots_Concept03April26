...
export class GoalManager extends Component {
    ...
    private readonly stagePaths: Vec2[][] = [
        [ // Stage 0: Cat (Blue)
            ...
            v2(7,7),   
            v2(6, 8), v2(5, 8), v2(4, 8), v2(3, 8), v2(2, 8), v2(1, 8),
            v2(2, 7), v2(3, 6), v2(4, 5), v2(4, 4), v2(3, 3), v2(2, 2), v2(1, 2)
        ],
        [ // Stage 1: Star (Yellow)
            v2(1, 5), v2(3, 4), v2(5, 3), v2(7, 3), v2(9, 2), 
            v2(8, 4), v2(7, 5), v2(5, 7), v2(4, 9), v2(4, 7), 
            v2(4, 5), v2(4, 3), v2(4, 1), v2(5, 3), v2(7, 5), 
            v2(8, 6), v2(9, 8), v2(7, 7), v2(5, 7), v2(3, 6), v2(1, 5)
        ],
        [ // Stage 2: Home (Green)
            v2(8, 3), v2(8, 7), v2(4, 7), v2(4, 3), v2(8, 3), 
            v2(4, 3), v2(1, 5), v2(4, 7)
        ]
    ];
